...
Ptr<SequentialRandomVariable> fd = CreateObject<SequentialRandomVariable> ();
 ...
 // Ptr<UniformRandomVariable> fd = CreateObject<UniformRandomVariable> ();
  ...
  for(int i = 0; i < 200; i++)
  { if((i<=90)||((i>100)&&(i<190))||((i>200)&&(i<290))||(i>310))
    { 
...
//lteHelper->AttachToClosestEnb (ueLteDevs, enbLteDevs);
 ...
 Ptr<UniformRandomVariable> startTimeSeconds = CreateObject<UniformRandomVariable> ();
  startTimeSeconds->SetAttribute ("Min", DoubleValue (2));
  startTimeSeconds->SetAttribute ("Max", DoubleValue (5));
