...
main (int argc, char *argv[])
{
  ...
  int maxPackets = 2;
  int sectorNum = 1;
  double ueDistance = 100;
  uint32_t buildingWidth = 50;
...
// remHelper->SetAttribute ("XMax", DoubleValue (distanceRem));
// remHelper->SetAttribute ("XRes", UintegerValue (1000));
// remHelper->SetAttribute ("YMin", DoubleValue (-1.5*1000));
// remHelper->SetAttribute ("YMax", DoubleValue (1.5*1000));
