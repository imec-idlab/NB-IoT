...
//NB-IOT Defines for tones and repetitions and MCS

//Enable MCS based link adaptation
#define MCS 1

//Enable Tone based link adaptation
#define TONE 0
#define SUBCARRIER 0 // set to 1 if TONE=1. Else set to 0. This means we use subcarriers for allocation instead of RB

//Enable Repetition based link adaptation
#define REPEAT 0

//Enable hybrid  link adaptation
#define ANALYTICAL 0 // using lagrange (or)
#define EXHAUSTIVE 0 // using exhaustive method


// see 36.213 section 8
#define UL_PUSCH_TTIS_DELAY 9
#define DL_PDSCH_TTIS_DELAY 1

#define HARQ_PERIOD 1
