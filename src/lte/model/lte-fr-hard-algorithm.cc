...
LteFrHardAlgorithm::DoInitialize ()
{
  ...
  NS_ASSERT_MSG (m_dlBandwidth > 5,"DlBandwidth must be at least 15 to use FFR algorithms");
  NS_ASSERT_MSG (m_ulBandwidth > 5,"UlBandwidth must be at least 15 to use FFR algorithms");
