...
if ( n_times1 <= 1)
        ...
        n_times=8;
else if (n_times1>8 && n_times1<=24)
        n_times=16;    
else if (n_times1>24 && n_times1<=48)
          n_times=32;
else if (n_times1>48 && n_times1<=80)
           n_times=64;
else if(n_times1>80 )
        n_times=128;
...
/*
if( scleft.at(rb_start)==12)  
{  if (cqi>=14 && cqi<= 15)
      {              
         sfleft.at(rb_start)= 0;
         uldci.m_scindication = 18; //Subcarrier indication between 0 to 64 6 bits; It is 18 for 12 tone
         scleft.at(rb_start) =  scleft.at(rb_start)-12;
        
      }
      else if (cqi>=10 && cqi<=13)
      {
         sfleft.at(rb_start)= 2;
         uldci.m_scindication = 16; //Subcarrier indication between 0 to 64 6 bits; It is 18 for 12 tone
         scstart.at(rb_start) = 0;
         scleft.at(rb_start) =  scleft.at(rb_start)-6;   
         scstart.at(rb_start) = scstart.at(rb_start)+6;    
      ...
      else if (cqi>=6 && cqi<=9)
      {
         ...
         sfleft.at(rb_start)= 4;
         uldci.m_scindication = 12; //Subcarrier indication between 0 to 64 6 bits; It is 18 for 12 tone
         scstart.at(rb_start) = 0;
         scleft.at(rb_start) =  scleft.at(rb_start)-3;  
          scstart.at(rb_start) = scstart.at(rb_start)+3;      
...
/*If RB is in use, but some subcarriers are left*/
...
/*else
{
 ...
 if ( scleft.at(rb_start)>=6 && (scstart.at(rb_start) ==0 || scstart.at(rb_start) ==6 ) && cqi>=10)
     {
        sfleft.at(rb_start)= 2;
 //Subcarrier indication between 0 to 64 6 bits; It is 18 for 12 tone
...
else if ( scleft.at(rb_start)>=3 && (scstart.at(rb_start) ==0 || scstart.at(rb_start) ==3 || scstart.at(rb_start) ==6 || scstart.at(rb_start) ==9) && cqi>=6)
     {
       sfleft.at(rb_start)= 4;
 //Subcarrier indication between 0 to 64 6 bits; It is 18 for 12 tone
...
/* switch(cqi)
{
	...
	case 14:
	case 13:
	case 12:uldci.m_repetitionNumber=1; break;
	case 11:
	case 10:uldci.m_repetitionNumber=2; break;
	case 9:
	case 8: uldci.m_repetitionNumber=4; break;
	case 7: 
	case 6: uldci.m_repetitionNumber=8; break;
	case 5: uldci.m_repetitionNumber=16; break;
	case 4: uldci.m_repetitionNumber=32; break;
	case 3: uldci.m_repetitionNumber=64; break;
	case 2: 
	case 1: uldci.m_repetitionNumber=128; break;
	case 0: uldci.m_repetitionNumber=128; break;
